...
for s=1:1:length(handles.MyLineSet.LineX)
    ...
    for t=1:1:length(handles.MyLineSet.LineIndex(s).MyCircuit.CircuitIndex)
        step=step+1;
        waitbar(step/steps);
        Str1=['第',num2str(t),'回线路'];
        Str2=[char(t+65),num2str(8)];
        Str3=[handles.MyLineSet.LineIndex(s).MyCircuit.AX(t),handles.MyLineSet.LineIndex(s).MyCircuit.AY(t),handles.MyLineSet.LineIndex(s).MyCircuit.BX(t),handles.MyLineSet.LineIndex(s).MyCircuit.BY(t),handles.MyLineSet.LineIndex(s).MyCircuit.CX(t),handles.MyLineSet.LineIndex(s).MyCircuit.CY(t),handles.MyLineSet.LineIndex(s).MyCircuit.SplitNum(t),handles.MyLineSet.LineIndex(s).MyCircuit.SplitRadius(t),handles.MyLineSet.LineIndex(s).MyCircuit.LineRadius(t),handles.MyLineSet.LineIndex(s).MyCircuit.Voltage(t),handles.MyLineSet.LineIndex(s).MyCircuit.Current(t)]';
